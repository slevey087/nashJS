...
function initializePlayableClass(playableClass){
	...
	console.log(playableClass.prototype.play)
...
exports.playableClasses = {_Playable, _Choice, _Turn, _Sequence, _Loop, _SLoop, _Halt, _SHalt, _Lambda, _RPChoice, _PopulationDynamics};
exports.playableInterfaces = {Choice, Turn, Sequence, Loop, StochasticLoop, HaltIf, StochasticHalt, Lambda, RandomPlayerChoice, PopulationDynamics};
