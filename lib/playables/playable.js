...
var { outcomeTreeAddAll, outcomeTreeGetValue } = require("../helperFunctions")(
  "playable"
);
...
function _Playable(id, parameters = {}) {
  ...
  parameters.initializePlayers
    ? (this.initializePlayers = parameters.initializePlayers)
    : null;
}
...
_Playable.prototype.checkInit = function(
  { initializePlayers = this.initializePlayers } = {},
  result
) {
  return initializePlayers
    ? reinitializePlayers(result)
...
_Playable.prototype.handleHistory = function(
  { history = gameHistory } = {},
  result
) {
...
playablePrototype.constructor = function(_playable) {
  ...
  this.call = function(source) {
    ...
    return SynchronousPromise.all([
      ...
      (function() {
        if (
          !(source instanceof Promise || source instanceof SynchronousPromise)
        ) {
