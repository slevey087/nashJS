...
_Choice.prototype.play = function({initializePlayers=false, usePayoffs=false, shortCircuit=false, history=gameHistory, releasePlayer=true}={}){
	...
	return Promise.resolve().then(function(){
		...
		if (usePayoffs) {	
			...
			var scoreEntry = {
				...
				scoreChange:Number(choice.payoffs[result])
			}
