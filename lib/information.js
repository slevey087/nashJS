...
Information.prototype.update = function(player, local) {
	...
	this.infoHistory = this.history.print();
	this.infoHistory.log = this.history.log.print();
	this.infoHistory.scores = gameHistory.scores.print();
...
Information.prototype.deliver = function(player, local) {
	var information = { history: { log: this.infoHistory.log, scores: this.infoHistory.scores }, population: this
			.infoPopulation }
