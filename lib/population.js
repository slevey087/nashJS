...
function PlayerList(...args) {
	...
	if (args == "all") return _Population();
...
PlayerList.prototype.exclude = function(playerArg){
	...
	return new PlayerList(this.filter(function(player){
		if (playerArg === player || playerArg == player.interface || playerArg == player.id) 
			return false;
		else return true;
	}));
}
...
var Population = function(){
	return new UserPlayerList(_Population());
}
...
module.exports = {PlayerList, UserPlayerList, _Population, Population};